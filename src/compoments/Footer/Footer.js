        ...
        <div className="footer-area">
            <Row className="footer">
                <Col md={4} className="footer-head">
                    <h4> <img src={logo} style={{ width: '2em' }} alt="" /> Apple Watch
                    </h4>
                    <Row className="mt-5">
                        ...
                        <Col className="default-color">
                            ...
                            <small>applewatch@mail.com</small><br />
                        </Col>
                    </Row>
                </Col>
                <Col md={4}>
            ...
            <hr />
            <p className="text-center default-color">&#169; <img src={logo} style={{ width: '1em' }} alt="" /> Apple Watch
                2021</p>
        </div>
    );
};
